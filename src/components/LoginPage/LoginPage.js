...
const LoginPage = (props) => {
  ...
  const [teacherModalShow, setTeacherModalShow] = React.useState(false);
    ...
    <>
      ...
      <div className="mt-5 pt-5 d-flex justify-content-center">
        ...
        <div className="md-5 pd-5">
          ...
          <LoginModal
            isUserLoggedIn={props.isUserLoggedIn} setUserLoggedIn={props.setUserLoggedIn}
            setHomeAction={props.setHomeAction}
            show={teacherModalShow}
            onHide={() => setTeacherModalShow(false)}
          ></LoginModal>
        </div>
      </div>
    </>
